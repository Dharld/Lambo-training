    ...
    <div className="w-full rounded-sm shadow-sm">
      ...
      <div className="mt-4">
        {data.map((user) => (
          <div
            key={user.user_id}
            className="flex justify-between items-center p-4 bg-white shadow-sm rounded-md mb-2 cursor-pointer hover:bg-slate-50 transition-colors"
          >
            ...
            <div className="w-1/8 text-sm text-gray-700 text-center border border-t-0 border-b-0 border-r border-l px-4 mr-4 ">
              {user.role_name}
            </div>
